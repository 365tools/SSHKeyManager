...
```powershell
Invoke-WebRequest -Uri https://raw.githubusercontent.com/365tools/sshm/main/scripts/install.ps1 -OutFile install.ps1
...
```bash
# 下载安装脚本
curl -O https://raw.githubusercontent.com/365tools/sshm/main/scripts/install.sh
chmod +x install.sh
