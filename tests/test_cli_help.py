...
@pytest.mark.parametrize('args', [
    ['key', 'list'], ['key', 'create'], ['key', 'remove'], ['key', 'rename'],
    ['key', 'label'], ['key', 'switch'], ['key', 'current'],
    ['repo', 'use'], ['repo', 'clone'], ['repo', 'info'], ['repo', 'test'],
    ['backup', 'create'], ['backup', 'list'], ['backup', 'restore'],
    ['author', 'list'], ['author', 'add'], ['author', 'update'],
    ['author', 'remove'], ['author', 'use'], ['author', 'unset'],
    ['history', 'rewrite'],
    ['config', 'language'], ['config', 'auto-author'], ['config', 'update'],
])
